...
INSERT INTO users (user_id, password, role, name, email)
VALUES 
('admin1', SHA2('password123', 256), 'admin', 'Ramesh', 'john.doe@example.com'),
('admin2', SHA2('securepass456', 256), 'admin', 'Suresh', 'jane.smith@example.com'),
('admin3', SHA2('adminpass789', 256), 'admin', 'Ganesh', 'bob.johnson@example.com');
-- INSERT INTO users (user_id, password, role, name, email)
